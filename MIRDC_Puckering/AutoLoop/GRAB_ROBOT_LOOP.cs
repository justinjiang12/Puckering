...
{
    delegate void A_GRAB_DO(ushort num, bool state);

    class GRAB_ROBOT_LOOP
    {
        #region 委派專用欄位
        public event A_GRAB_DO e_Signal_output_1;
        public event A_GRAB_DO e_Signal_output_2;
        public event A_GRAB_DO e_Signal_output_3;
        public event A_GRAB_DO e_Signal_output_4;
        public event A_GRAB_DO e_Signal_output_5;
        public event A_GRAB_DO e_Signal_output_6;
